...
หาก tab `Matches` ยังเป็นค่าว่างหรือมีแค่ข้อมูลตัวอย่าง ระบบเวอร์ชันล่าสุดจะสร้างแถวใหม่จาก provider ให้เอง และ response จะขึ้น `created X new matches` พร้อม log `New matches created in the Matches sheet`
